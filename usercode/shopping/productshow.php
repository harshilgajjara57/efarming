			...
			<div class="wrap_header">
				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							<li>
								<img src="../images/logo/logo.png" height="40px" width="70px">
								<a href="">E-Farming</a>
							</li>
						</ul>
					</nav>
	...
	<section class="bgwhite p-t-55 p-b-65">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9">
				<?php					
				    $q="SELECT * FROM product where category_id='$cate';";
						...
						while ($row=mysqli_fetch_array($query)) 
						{
							...
							?><div class="div" style="float: left;margin-left: 10px;">
								<table >
									...
									<tr><td><a href="addtocart.php?msg=<?php echo $id; ?>">ADD TO CART</td></tr>
									<?php
								}
								?>
								</table>
