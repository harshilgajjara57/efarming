...
$table='<table border="1">
        ...
        <tr>
            ...
            <th style="font-family: Times New Roman;font-size: 10px;"><b>product details</b></th>
...
$result=mysqli_query($conn,"select * from product;");
        while($row=mysqli_fetch_assoc($result))
        {
           ...
           // $resultset=mysqli_query($con,"select * from user_registration");
            ...
            $table.='   
                <tr>
                    <td style="font-family: Times New Roman;font-size: 10px;">'.$row['product_id'].'</td>
                    ...
                    <td style="font-family: Times New Roman;font-size: 10px;">'.$row['product_details'].'</td>
