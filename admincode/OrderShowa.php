          ...
          <div class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top justify-content-center">
                        ...
                        <div class="col-12 data_tables">
                            ...
                            <div class="card">
                                <div class="card-header bg-white">
                                    <i class="fa fa-table"><h3>PRODUCT DETAILS</h3></i>
                                </div>
            ...
            <tbody>
             ...
             <!-- <tr>
               ...
               <td><?php ?><img src="../usercode/images/productimage/<?php echo $result['photo']; ?>" width="70" height="70" alt="NO IMAGE"></td>
                <td><?php
            ...
            ?>
                                    ...
                                    <a href="order_data_pdf_converter.php" class="btn btn-primary glow_button"> 
                                    PDF
                                  </a>
                                  <a href="order_data_excel_converter.php" class="btn btn-primary glow_button"> 
                                    Excel
                                  </a>
                                    </a>
                                </div>
